    ...
    this.service.get(data).subscribe(response => {
      ...
      if (response.data === 'unauthorized') {
        ...
        if (this.userInfo.type === 1) {
          ...
          this.userInfo.dataStudent.actaCumplimiento = response.additional_data.st_acta_cumplimiento ? response.additional_data.st_acta_cumplimiento : '';
          ...
          this.userInfo.dataStudent.pazSalvo = response.additional_data.st_paz_salvo ? response.additional_data.st_paz_salvo : '';
        }
